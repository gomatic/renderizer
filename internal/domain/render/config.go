...
// root supplies. It carries no behavior. The boolean fields are named for the
// enabled state they toggle, matching their named types.
type Config struct {
	Source            io.Reader
	Environ           EnvironFunc
	Getwd             GetwdFunc
	...
	CapitalizeEnabled Capitalization
